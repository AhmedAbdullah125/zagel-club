                                ...
                                !profile ?
                                    ...
                                    <>
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent dir={lang === 'ar' ? 'rtl' : 'ltr'} className=" user-dropdown profile-dropdown">
                                                <DropdownMenuLabel className="text-center text-lg font-semibold py-3">
                                                    {t(lang, "welcome")}
                                                </DropdownMenuLabel>
                                                <DropdownMenuSeparator />
                                                <DropdownMenuGroup className="p-2">
                                                    {/* Map through profile menu items */}
                                                    {profileMenuItems.map((item, index) => (
                                                        <DropdownMenuItem key={index} className="cursor-pointer">
                                                            <Link href={item.href} className="w-full flex items-center gap-2">
                                                                <div className={`flex-shrink-0 w-7 h-7 ${item.isDelete ? 'bg-red-600' : 'bg-primary'} rounded-lg flex items-center justify-center`}>
                                        ...
                                        <Link href="/notifications" className={`notification-cont ${profile.notifyCount > 0 ? 'has-notification' : ''}`}>
