...
export async function payRequest(data, setLoading, lang,) {
    setLoading(true)

    const url = `${API_BASE_URL}/service-requests/pay`;
    const formData = new FormData();
    formData.append('id', data.requestId);
    formData.append('type', data.paymentMethod == "bank" ? "online" : "wallet");
