...
export async function changePhone(countryCode, phone, setLoading, lang, nextStep, setNewPhone, setNewCountyCode) {
    setLoading(true)
    const url = `${API_BASE_URL}/auth/change-phone`;
    const formData = new FormData();
    formData.append('newCountryCode', countryCode);
