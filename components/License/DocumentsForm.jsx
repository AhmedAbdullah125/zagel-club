...
const makeFormSchema = (lang) =>
    z.object({
        licenseType: z.string({ message: t(lang, "license_type_required") }).min(1, { message: t(lang, "license_type_required") }),
        clubApproval: z
            .any()
...
export default function DocumentsForm({ lang, formData, setFormData, setStep, progress, setProgress, setMaxProgress }) {
    ...
    useEffect(() => {
        const subscription = form.watch((value) => {
            let filledInputs = 0;
            const totalInputs = 2; // licenseType and clubApproval
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="form-field">
                                            <FormLabel className="field-label">
                                                {t(lang, "license_type_placeholder")} <span className="required">*</span>
                                            </FormLabel>
                                            <FormControl>
